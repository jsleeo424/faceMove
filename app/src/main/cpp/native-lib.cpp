...
//Java_com_example_facemove_MainActivity_ConvertRGBtoGray(JNIEnv *env, jobject thiz,
...
Java_com_example_facemove_MainActivity_loadCascade(JNIEnv *env, jobject thiz,
...
extern "C"
JNIEXPORT void JNICALL
Java_com_example_facemove_MainActivity_detect(JNIEnv *env, jobject thiz,
    ...
    for (int i = 0; i < faces.size(); i++) {
        ...
        __android_log_print(ANDROID_LOG_DEBUG, (char *) "face :: ", (char *) "face is at %d, %d", center.x, center.y);
        ...
        for ( size_t j = 0; j < eyes.size(); j++ )
        {
            ...
            __android_log_print(ANDROID_LOG_DEBUG, (char *) "eye :: ", (char *) "eye %d is at %d, %d", j+1, eye_center.x, eye_center.y);
